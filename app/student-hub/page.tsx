      ...
      <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg border border-border p-6">
        <div className="flex items-start justify-between gap-6">
          <div className="flex gap-4 items-start">
            <img
              src={studentData.profilePhoto || "/placeholder.svg"}
              alt="Student"
          ...
          <div className="flex gap-3">
            <Badge className={studentData.presentToday ? "bg-success-green" : "bg-error-red"}>
              {studentData.presentToday ? "Present Today" : "Absent Today"}
            </Badge>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Semester 6</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
